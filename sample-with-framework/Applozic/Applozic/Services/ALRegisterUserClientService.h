...
//
static NSString *const INVALID_APPLICATIONID = @"INVALID_APPLICATIONID";
static NSString *const VERSION_CODE = @"111";
static NSString *const LOGOUT_URL = @"/rest/ws/device/logout";
