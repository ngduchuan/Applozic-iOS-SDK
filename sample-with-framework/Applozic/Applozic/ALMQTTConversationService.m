...
- (void)newMessage:(MQTTSession *)session data:(NSData *)data onTopic:(NSString *)topic qos:(MQTTQosLevel)qos retained:(BOOL)retained mid:(unsigned int)mid
{
    ...
    {
        if ([type isEqualToString: @"MESSAGE_RECEIVED"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_SYNC]])
        {
        ...
        else if ([type isEqualToString:@"MESSAGE_DELIVERED"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_DELIVERED]]) {
        ...
        else if([type isEqualToString:@"MESSAGE_DELETED"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_DELETE_MESSAGE]])
        {
        ...
        else if ([type isEqualToString:@"MESSAGE_DELIVERED_READ"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_MESSAGE_DELIVERED_AND_READ]])
        {
            NSArray  * deliveryParts = [[theMessageDict objectForKey:@"message"] componentsSeparatedByString:@","];
            NSString * pairedKey = deliveryParts[0];
            NSString * contactId = deliveryParts.count>1 ? deliveryParts[1]:nil;
        ...
        else if ([type isEqualToString:@"CONVERSATION_DELIVERED_AND_READ"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_CONVERSATION_DELIVERED_AND_READ]])
        {
        ...
        else if ([type isEqualToString:@"USER_CONNECTED"]||[type isEqualToString:[ALPushNotificationService notificationType:AL_USER_CONNECTED]])
        {
        ...
        else if ([type isEqualToString:@"GROUP_CONVERSATION_DELETED"] || [type isEqualToString:[ALPushNotificationService notificationType:AL_GROUP_CONVERSATION_DELETED]]){
        ...
        else if([type isEqualToString:[ALPushNotificationService notificationType:AL_MESSAGE_METADATA_UPDATE]]){ // MESSAGE_METADATA_UPDATE
            NSString* keyString;
            NSString* deviceKey;
            @try
            {
