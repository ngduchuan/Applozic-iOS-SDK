...
/// Client Group id in case if you have own client group id is set during create channel then you can use that.
@property (nonatomic, strong) NSString *clientGroupId;
///  Time Interval for which notification has be be disabled.
