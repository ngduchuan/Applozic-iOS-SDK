...
- (void)createConversation:(ALConversationProxy *)alConversationProxy
    ...
    [self.responseHandler authenticateAndProcessRequest:theRequest andTag:@"CREATE_CONVERSATION" WithCompletionHandler:^(id theJson, NSError *theError) {
...
- (void)fetchTopicDetails:(NSNumber *)alConversationProxyID
    ...
    [self.responseHandler authenticateAndProcessRequest:theRequest andTag:@"FETCH_TOPIC_DETAILS" WithCompletionHandler:^(id theJson, NSError *theError) {
